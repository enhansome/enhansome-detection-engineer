...
* [Awesome Lists | mthcht](https://github.com/mthcht/awesome-lists/tree/main/Lists) ⭐ 1,895 | 🐛 24 | 🌐 YARA | 📅 2026-08-29 - Includes keywords, paths from various tools that can be used to implement detection logic.
...
* [Atomic Red Team | Red Canary](https://github.com/redcanaryco/atomic-red-team/tree/master/atomics) ⭐ 12,462 | 🐛 30 | 🌐 C | 📅 2026-08-28 - Tests mapped to the MITRE ATT\&CK framework.
...
* [Infection Monkey](https://github.com/guardicore/monkey#infection-monkey) ⭐ 7,078 | 🐛 240 | 🌐 Python | 📅 2025-05-01 - Open-source adversary emulation platform.
...
* [Eventum](https://github.com/eventum-generator/eventum) ⭐ 63 | 🐛 4 | 🌐 Python | 📅 2026-08-29 - Data generation platform for producing synthetic event streams with complex correlations.
