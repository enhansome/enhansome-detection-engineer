...
* [Newsletters and Aggregators](#newsletters-and-aggregators) - Newsletters with updates on detection engineering.
...
* [Wazuh Ruleset](https://github.com/wazuh/wazuh/tree/master/ruleset) ⭐ 16,991 | 🐛 3,076 | 🌐 C++ | 📅 2026-09-24 - Wazuh ruleset repository.
* [Sigma Rules](https://github.com/SigmaHQ/sigma) ⭐ 11,088 | 🐛 222 | 🌐 Python | 📅 2026-09-24 - Huge collection of detection rules from SIGMA HQ.
* [Sentinel Detections](https://github.com/Azure/Azure-Sentinel/tree/master/Detections) ⭐ 6,145 | 🐛 119 | 🌐 Python | 📅 2026-09-24 and [Sentinel Solution Rules](https://github.com/Azure/Azure-Sentinel/tree/master/Solutions) ⭐ 6,145 | 🐛 119 | 🌐 Python | 📅 2026-09-24- Collection of KQL detection queries for Sentinel.
* [Elastic Rules](https://www.elastic.co/guide/en/security/current/prebuilt-rules.html), [Elastic Detection Rules Explorer](https://elastic.github.io/detection-rules-explorer) or [Elastic Rules GitHub Repository](https://github.com/elastic/detection-rules/tree/main/rules) ⭐ 2,700 | 🐛 296 | 🌐 Python | 📅 2026-09-24- Elastic's detection rules.
* [KQL Queries | Bert-JanP](https://github.com/Bert-JanP/Hunting-Queries-Detection-Rules/tree/main) ⭐ 1,752 | 🐛 0 | 🌐 Python | 📅 2026-09-16 - Collection of KQL queries.
* [Splunk Rules](https://research.splunk.com/detections/) and [Splunk Rules GitHub Repository](https://github.com/splunk/security_content/tree/develop/detections) ⭐ 1,697 | 🐛 18 | 🌐 Python | 📅 2026-09-24 - Splunk's detection rules.
* [KQL Queries for Sentinel | reprise99](https://github.com/reprise99/Sentinel-Queries) ⭐ 1,651 | 🐛 9 | 📅 2026-01-29 - Collection of KQL queries.
* [Elastic Security for Endpoint Rules](https://github.com/elastic/protections-artifacts/tree/main) ⭐ 1,494 | 🐛 9 | 🌐 YARA | 📅 2026-09-21- Elastic's Security for Endpoint detection rules.
* [KQL Queries | SlimKQL](https://github.com/SlimKQL/Hunting-Queries-Detection-Rules) ⭐ 932 | 🐛 10 | 🌐 JavaScript | 📅 2026-09-18 - Collection of KQL queries.
* [KQL Queries | FalconForce](https://github.com/FalconForceTeam/FalconFriday/tree/master) ⭐ 923 | 🐛 2 | 📅 2026-05-07 - Collection of KQL queries.
* [KQL Queries | Cyb3r Monk](https://github.com/Cyb3r-Monk/Threat-Hunting-and-Detection/tree/main) ⭐ 822 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-08-14 - Collection of KQL queries.
* [KQL Queries | cyb3rmik3](https://github.com/cyb3rmik3/KQL-threat-hunting-queries) ⭐ 797 | 🐛 0 | 📅 2026-06-03 - Collection of KQL queries.
* [Chronicle (GCP) Rules](https://github.com/chronicle/detection-rules) ⭐ 516 | 🐛 13 | 🌐 Python | 📅 2026-08-06 - Detection rules written for the Chronicle Platform.
* [Sigma Rules | mdecrevoisier](https://github.com/mdecrevoisier/SIGMA-detection-rules) ⭐ 443 | 🐛 23 | 📅 2026-05-21 - Collection of sigma rules.
...
* [KQL Queries | SecurityAura](https://github.com/SecurityAura/DE-TH-Aura) ⭐ 290 | 🐛 0 | 📅 2026-06-23 - Collection of KQL queries.
...
* [Sigma Rules | Yamato Security](https://github.com/Yamato-Security/hayabusa-rules/tree/main/sigma) ⭐ 223 | 🐛 2 | 🌐 Python | 📅 2026-09-24 - Collection of sigma rules.
* [Sigma Rules | mbabinski](https://github.com/mbabinski/Sigma-Rules/tree/main) ⭐ 165 | 🐛 1 | 📅 2025-11-25 - Collection of sigma rules.
...
* [KQL Queries for DefenderATP | 0xAnalyst](https://github.com/0xAnalyst/DefenderATPQueries) ⭐ 84 | 🐛 1 | 📅 2026-07-07 - Collection of KQL queries.
* [Sigma Rules Threat Hunting Keywords | mthcht](https://github.com/mthcht/ThreatHunting-Keywords-sigma-rules/tree/main/sigma_rules/offensive_tools) ⭐ 60 | 🐛 0 | 🌐 Python | 📅 2025-03-02 - Collection of sigma rules.
* [Sigma Rules | Inovasys-CS](https://github.com/Inovasys-CS/EDI/tree/main) ⭐ 18 | 🐛 0 | 🌐 Python | 📅 2026-08-24 - Collection of sigma rules.
* [Sigma Rules | RussianPanda95](https://github.com/RussianPanda95/Sigma-Rules) ⭐ 10 | 🐛 0 | 📅 2025-04-20 - Collection of sigma rules.
...
* [Awesome Lists | mthcht](https://github.com/mthcht/awesome-lists/tree/main/Lists) ⭐ 1,918 | 🐛 28 | 🌐 YARA | 📅 2026-09-24 - Includes keywords, paths from various tools that can be used to implement detection logic.
...
* [EVTX Attack Samples](https://github.com/sbousseaden/EVTX-ATTACK-SAMPLES) ⭐ 2,628 | 🐛 5 | 🌐 HTML | 📅 2023-01-24 - Event viewer attack samples.
* [Security Datasets](https://github.com/OTRF/Security-Datasets/tree/master/datasets) ⭐ 1,820 | 🐛 14 | 🌐 PowerShell | 📅 2024-03-20 - Datasets of malicious and benign indicators, from different platforms.
* [Attack Data | Splunk](https://github.com/splunk/attack_data) ⭐ 820 | 🐛 4 | 🌐 Python | 📅 2026-09-24 A repository of datasets from various attacks
* [EVTX to MITRE Attack](https://github.com/mdecrevoisier/EVTX-to-MITRE-Attack) ⭐ 643 | 🐛 0 | 📅 2026-05-21 - IOCs in EVTX format.
* [PCAP-ATTACK | sbousseaden](https://github.com/sbousseaden/PCAP-ATTACK) ⭐ 374 | 🐛 2 | 📅 2021-04-29 - PCAP captures mapped to the relevant attack tactic.
...
* [Atomic Red Team | Red Canary](https://github.com/redcanaryco/atomic-red-team/tree/master/atomics) ⭐ 12,578 | 🐛 35 | 🌐 C | 📅 2026-09-14 - Tests mapped to the MITRE ATT\&CK framework.
* [Game of Active Directory Lab | Orange CyberDefense](https://github.com/Orange-Cyberdefense/GOAD) ⭐ 8,374 | 🐛 154 | 🌐 PowerShell | 📅 2026-03-12 -The purpose of this lab is to give pentesters a vulnerable Active directory environment ready to use to practice usual attack techniques.
* [Infection Monkey](https://github.com/guardicore/monkey#infection-monkey) ⭐ 7,093 | 🐛 240 | 🌐 Python | 📅 2025-05-01 - Open-source adversary emulation platform.
* [APT Simulator](https://github.com/NextronSystems/APTSimulator#apt-simulator) ⭐ 2,773 | 🐛 4 | 🌐 Batchfile | 📅 2025-09-23 - Windows batch script that uses a set of tools and output files to make a system look as if it was compromised.
* [Stratus Red Team | DataDog](https://github.com/DataDog/stratus-red-team) ⭐ 2,405 | 🐛 74 | 🌐 Go | 📅 2026-09-24 - Similar to red team atomics but for cloud.
* [Network Flight Simulator](https://github.com/alphasoc/flightsim#network-flight-simulator) ⭐ 1,364 | 🐛 24 | 🌐 Go | 📅 2024-04-04 - Lightweight utility used to generate malicious network traffic.
* [Network Flight Simulator](https://github.com/alphasoc/flightsim) ⭐ 1,364 | 🐛 24 | 🌐 Go | 📅 2024-04-04 - Flightsim is a lightweight utility used to generate malicious network traffic.
...
* [Eventum](https://github.com/eventum-generator/eventum) ⭐ 66 | 🐛 4 | 🌐 Python | 📅 2026-09-08 - Data generation platform for producing synthetic event streams with complex correlations.
...
* [Sysmon Configuration | SwiftOnSecurity](https://github.com/SwiftOnSecurity/sysmon-config) ⭐ 5,658 | 🐛 82 | 📅 2024-07-03
* [Sysmon Configuration | Olaf Hartong](https://github.com/olafhartong/sysmon-modular) ⭐ 3,141 | 🐛 50 | 🌐 Go | 📅 2026-09-18
* [Auditd Logging Configuration | Neo23x0](https://github.com/Neo23x0/auditd/blob/master/audit.rules) ⭐ 1,946 | 🐛 19 | 🌐 Shell | 📅 2026-05-04
...
* [DeTT\&CT](https://github.com/rabobank-cdc/DeTTECT/) ⭐ 2,341 | 🐛 16 | 🌐 SCSS | 📅 2026-09-14 - DeTT\&CT aims to assist blue teams in using ATT\&CK to score and compare data log source quality, visibility coverage, detection coverage and threat actor behaviors.
* [EDR Telemetry | tsale](https://github.com/tsale/EDR-Telemetry/tree/main) ⭐ 1,986 | 🐛 13 | 🌐 Python | 📅 2026-09-23 - Telemetry comparison and telemetry generator for different EDRs.
* [Alerting and Detection Strategies (ADS) Framework | Palantir](https://github.com/palantir/alerting-detection-strategy-framework#alerting-and-detection-strategies-framework) ⭐ 908 | 🐛 3 | 📅 2025-09-08- A structured approach to designing and documenting effective detection methodologies.
...
* [Adversarial Detection Engineering Framework](https://github.com/NikolasBielski/Adversarial-Detection-Engineering-Framework) ⭐ 61 | 🐛 0 | 📅 2026-03-05 - Adversarial Detection Engineering (ADE) is the discipline of reasoning about False Negatives in detection rules.
...
* [Detection LAB](https://github.com/clong/DetectionLab/) ⭐ 5,028 | 🐛 42 | 🌐 HTML | 📅 2024-07-06
* [Splunk Attack Range](https://github.com/splunk/attack_range) ⭐ 2,559 | 🐛 22 | 🌐 Python | 📅 2026-09-24
* [PurpleLab](https://github.com/Krook9d/PurpleLab) ⭐ 746 | 🐛 15 | 🌐 PHP | 📅 2026-08-22
...
* [Detection Engineering Weekly | Zack Allen](https://www.detectionengineering.net/) - A newsletter with weekly detection related online sources.
* [Detect.fyi | Alex Teixeira](https://detect.fyi/) - Collection of good detection engineering articles.
...
* [A Dance of Red and Blue: The Art and Science of Detection Engineering](https://www.amazon.com/dp/B0GT1MD1R3)
...
* [FalconForce Advanced Detection Engineering in the Enterprise training](https://falconforce.nl/services/training)
...
* [@sigma\_hq](https://x.com/sigma_hq)
* [@cyb3rops](https://x.com/cyb3rops)
* [@frack113](https://x.com/frack113)
* [@nas\_bench](https://x.com/nas_bench)
...
* [Awesome Threat Detection | 0x4D31](https://github.com/0x4D31/awesome-threat-detection) ⭐ 4,730 | 🐛 60 | 📅 2026-01-05
* [Awesome Detection Engineering | infosecB](https://github.com/infosecB/awesome-detection-engineering) ⭐ 1,347 | 🐛 13 | 📅 2026-08-03
* [Detection Engineering Starter Pack | rfackroyd](https://github.com/rfackroyd/detection-engineering-starter-pack) ⭐ 195 | 🐛 4 | 📅 2026-06-04
