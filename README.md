...
* [Wazuh Ruleset](https://github.com/wazuh/wazuh/tree/master/ruleset) ⭐ 16,998 | 🐛 3,068 | 🌐 C++ | 📅 2026-09-25 - Wazuh ruleset repository.
* [Sigma Rules](https://github.com/SigmaHQ/sigma) ⭐ 11,092 | 🐛 221 | 🌐 Python | 📅 2026-09-25 - Huge collection of detection rules from SIGMA HQ.
* [Sentinel Detections](https://github.com/Azure/Azure-Sentinel/tree/master/Detections) ⭐ 6,149 | 🐛 118 | 🌐 Python | 📅 2026-09-25 and [Sentinel Solution Rules](https://github.com/Azure/Azure-Sentinel/tree/master/Solutions) ⭐ 6,149 | 🐛 118 | 🌐 Python | 📅 2026-09-25- Collection of KQL detection queries for Sentinel.
* [Elastic Rules](https://www.elastic.co/guide/en/security/current/prebuilt-rules.html), [Elastic Detection Rules Explorer](https://elastic.github.io/detection-rules-explorer) or [Elastic Rules GitHub Repository](https://github.com/elastic/detection-rules/tree/main/rules) ⭐ 2,701 | 🐛 283 | 🌐 Python | 📅 2026-09-25- Elastic's detection rules.
...
* [Splunk Rules](https://research.splunk.com/detections/) and [Splunk Rules GitHub Repository](https://github.com/splunk/security_content/tree/develop/detections) ⭐ 1,698 | 🐛 20 | 🌐 Python | 📅 2026-09-24 - Splunk's detection rules.
...
* [Sigma Rules | mdecrevoisier](https://github.com/mdecrevoisier/SIGMA-detection-rules) ⭐ 445 | 🐛 23 | 📅 2026-05-21 - Collection of sigma rules.
...
* [Sigma Rules | Yamato Security](https://github.com/Yamato-Security/hayabusa-rules/tree/main/sigma) ⭐ 224 | 🐛 2 | 🌐 Python | 📅 2026-09-25 - Collection of sigma rules.
...
* [Awesome Lists | mthcht](https://github.com/mthcht/awesome-lists/tree/main/Lists) ⭐ 1,921 | 🐛 28 | 🌐 YARA | 📅 2026-09-25 - Includes keywords, paths from various tools that can be used to implement detection logic.
...
* [Security Datasets](https://github.com/OTRF/Security-Datasets/tree/master/datasets) ⭐ 1,821 | 🐛 14 | 🌐 PowerShell | 📅 2024-03-20 - Datasets of malicious and benign indicators, from different platforms.
* [Attack Data | Splunk](https://github.com/splunk/attack_data) ⭐ 821 | 🐛 4 | 🌐 Python | 📅 2026-09-24 A repository of datasets from various attacks
...
* [Atomic Red Team | Red Canary](https://github.com/redcanaryco/atomic-red-team/tree/master/atomics) ⭐ 12,582 | 🐛 38 | 🌐 C | 📅 2026-09-14 - Tests mapped to the MITRE ATT\&CK framework.
* [Game of Active Directory Lab | Orange CyberDefense](https://github.com/Orange-Cyberdefense/GOAD) ⭐ 8,377 | 🐛 150 | 🌐 PowerShell | 📅 2026-03-12 -The purpose of this lab is to give pentesters a vulnerable Active directory environment ready to use to practice usual attack techniques.
...
* [Stratus Red Team | DataDog](https://github.com/DataDog/stratus-red-team) ⭐ 2,406 | 🐛 74 | 🌐 Go | 📅 2026-09-24 - Similar to red team atomics but for cloud.
...
* [Eventum](https://github.com/eventum-generator/eventum) ⭐ 67 | 🐛 5 | 🌐 Python | 📅 2026-09-25 - Data generation platform for producing synthetic event streams with complex correlations.
...
* [Sysmon Configuration | SwiftOnSecurity](https://github.com/SwiftOnSecurity/sysmon-config) ⭐ 5,662 | 🐛 83 | 📅 2024-07-03
* [Sysmon Configuration | Olaf Hartong](https://github.com/olafhartong/sysmon-modular) ⭐ 3,142 | 🐛 51 | 🌐 Go | 📅 2026-09-18
...
* [EDR Telemetry | tsale](https://github.com/tsale/EDR-Telemetry/tree/main) ⭐ 1,987 | 🐛 13 | 🌐 Python | 📅 2026-09-23 - Telemetry comparison and telemetry generator for different EDRs.
* [Alerting and Detection Strategies (ADS) Framework | Palantir](https://github.com/palantir/alerting-detection-strategy-framework#alerting-and-detection-strategies-framework) ⭐ 909 | 🐛 3 | 📅 2025-09-08- A structured approach to designing and documenting effective detection methodologies.
...
* [Splunk Attack Range](https://github.com/splunk/attack_range) ⭐ 2,560 | 🐛 22 | 🌐 Python | 📅 2026-09-24
