...
* [Wazuh Ruleset](https://github.com/wazuh/wazuh/tree/master/ruleset) ⭐ 16,724 | 🐛 3,011 | 🌐 C++ | 📅 2026-08-30 - Wazuh ruleset repository.
* [Sigma Rules](https://github.com/SigmaHQ/sigma) ⭐ 10,959 | 🐛 209 | 🌐 Python | 📅 2026-08-18 - Huge collection of detection rules from SIGMA HQ.
* [Sentinel Detections](https://github.com/Azure/Azure-Sentinel/tree/master/Detections) ⭐ 6,082 | 🐛 118 | 🌐 Python | 📅 2026-08-30 and [Sentinel Solution Rules](https://github.com/Azure/Azure-Sentinel/tree/master/Solutions) ⭐ 6,082 | 🐛 118 | 🌐 Python | 📅 2026-08-30- Collection of KQL detection queries for Sentinel.
* [Elastic Rules](https://www.elastic.co/guide/en/security/current/prebuilt-rules.html), [Elastic Detection Rules Explorer](https://elastic.github.io/detection-rules-explorer) or [Elastic Rules GitHub Repository](https://github.com/elastic/detection-rules/tree/main/rules) ⭐ 2,696 | 🐛 234 | 🌐 Python | 📅 2026-08-29- Elastic's detection rules.
...
* [Splunk Rules](https://research.splunk.com/detections/) and [Splunk Rules GitHub Repository](https://github.com/splunk/security_content/tree/develop/detections) ⭐ 1,681 | 🐛 18 | 🌐 Python | 📅 2026-08-30 - Splunk's detection rules.
...
* [KQL Queries | SlimKQL](https://github.com/SlimKQL/Hunting-Queries-Detection-Rules) ⭐ 926 | 🐛 10 | 🌐 JavaScript | 📅 2026-08-30 - Collection of KQL queries.
* [KQL Queries | FalconForce](https://github.com/FalconForceTeam/FalconFriday/tree/master) ⭐ 922 | 🐛 2 | 📅 2026-05-07 - Collection of KQL queries.
...
* [KQL Queries | cyb3rmik3](https://github.com/cyb3rmik3/KQL-threat-hunting-queries) ⭐ 794 | 🐛 0 | 📅 2026-06-03 - Collection of KQL queries.
...
* [Awesome Lists | mthcht](https://github.com/mthcht/awesome-lists/tree/main/Lists) ⭐ 1,893 | 🐛 24 | 🌐 YARA | 📅 2026-08-30 - Includes keywords, paths from various tools that can be used to implement detection logic.
...
* [EVTX Attack Samples](https://github.com/sbousseaden/EVTX-ATTACK-SAMPLES) ⭐ 2,615 | 🐛 5 | 🌐 HTML | 📅 2023-01-24 - Event viewer attack samples.
* [Security Datasets](https://github.com/OTRF/Security-Datasets/tree/master/datasets) ⭐ 1,807 | 🐛 13 | 🌐 PowerShell | 📅 2024-03-20 - Datasets of malicious and benign indicators, from different platforms.
* [Attack Data | Splunk](https://github.com/splunk/attack_data) ⭐ 809 | 🐛 3 | 🌐 Python | 📅 2026-08-28 A repository of datasets from various attacks
...
* [Atomic Red Team | Red Canary](https://github.com/redcanaryco/atomic-red-team/tree/master/atomics) ⭐ 12,467 | 🐛 30 | 🌐 C | 📅 2026-08-28 - Tests mapped to the MITRE ATT\&CK framework.
* [Game of Active Directory Lab | Orange CyberDefense](https://github.com/Orange-Cyberdefense/GOAD) ⭐ 8,249 | 🐛 150 | 🌐 PowerShell | 📅 2026-03-12 -The purpose of this lab is to give pentesters a vulnerable Active directory environment ready to use to practice usual attack techniques.
* [Infection Monkey](https://github.com/guardicore/monkey#infection-monkey) ⭐ 7,081 | 🐛 240 | 🌐 Python | 📅 2025-05-01 - Open-source adversary emulation platform.
...
* [Stratus Red Team | DataDog](https://github.com/DataDog/stratus-red-team) ⭐ 2,380 | 🐛 68 | 🌐 Go | 📅 2026-08-26 - Similar to red team atomics but for cloud.
...
* [Sysmon Configuration | Olaf Hartong](https://github.com/olafhartong/sysmon-modular) ⭐ 3,121 | 🐛 49 | 🌐 PowerShell | 📅 2026-08-10
...
* [EDR Telemetry | tsale](https://github.com/tsale/EDR-Telemetry/tree/main) ⭐ 1,982 | 🐛 15 | 🌐 Python | 📅 2026-08-12 - Telemetry comparison and telemetry generator for different EDRs.
...
* [Detection LAB](https://github.com/clong/DetectionLab/) ⭐ 5,011 | 🐛 42 | 🌐 HTML | 📅 2024-07-06
...
* [Awesome Threat Detection | 0x4D31](https://github.com/0x4D31/awesome-threat-detection) ⭐ 4,714 | 🐛 54 | 📅 2026-01-05
* [Awesome Detection Engineering | infosecB](https://github.com/infosecB/awesome-detection-engineering) ⭐ 1,333 | 🐛 8 | 📅 2026-08-03
